...
let age: number = 29; // 숫자 값 할당
let isStudent: boolean = true; // true 또는 false 값 할당
let userName: string = "hofe"; // 이름을 문자열로 할당
...
let unknownValue2 = unknownValue as string;
...
type UserInfo = User | Admin |Guest;
